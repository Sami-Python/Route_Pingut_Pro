...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Future<void> _searchRoute() async {
    ...
    // Demo coordinates (Helsinki -> Tampere)
    final originLat = 60.1699;
    final originLon = 24.9384;
    final destLat = 61.4978;
    final destLon = 23.7610;

    if (mounted) {
      setState(() => _isLoading = false);
      
      // Navigate to map with demo data
      context.pushNamed(
        'map',
        extra: {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('🎉 Demo-reitti ladattu! (API-integraatio tulossa)'),
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: Text(_isLoading ? 'Haetaan...' : 'Hae reitti (Demo)'),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Demo-tila: Näyttää Helsinki → Tampere reitin',
